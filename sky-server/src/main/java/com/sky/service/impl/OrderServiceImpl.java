...
*/
        ...
        jsonObject.put("code", "PRDERPAID");
        OrderPaymentVO vo = jsonObject.toJavaObject(OrderPaymentVO.class); // old
        vo.setPackageStr(jsonObject.getString("package")); // old

        // 为替代微信支付成功后数据库订单状态更新，多定义一个方法进行修改
        Integer OrderPaidStatus = Orders.PAID;  // 支付状态 已支付
        Integer OrderStatus = Orders.TO_BE_CONFIRMED;   // 订单状态 待接单

        // 发现没有将支付时间 check_out属性赋值 所以在这里更新
        LocalDateTime check_time_out =LocalDateTime.now();
    ...
    public void userCancelById(Long id) throws Exception {
        ...
        // 更新订单状态 取消原因、取消时间
        orders.setStatus(OrderVO.CANCELLED);
    ...
    public PageResult conditionSearch(OrdersPageQueryDTO ordersPageQueryDTO) {
        ...
        // 部分订单状态 需要额外返回订单菜品信息 将orders 转化为orderVO
    ...
    public OrderStatisticsVO statistics() {
        ...
        orderStatisticsVO
                .setToBeConfirmed(toBeConfirmed);
        orderStatisticsVO
                .setConfirmed(confirmed);
        orderStatisticsVO
                .setDeliveryInProgress(deliveryInProgress);
    ...
    public void cancel(OrdersCancelDTO ordersCancelDTO) throws Exception{
        ...
        // 管理端取消订单需要退款 根据订单id更改订单状态、取消原因、取消时间
        Orders orders = new Orders();
